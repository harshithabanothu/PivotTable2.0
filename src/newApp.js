...
function App() {
  ...
  const renderColumn3 = (col2Data) => {
    console.log("1234",col2Data);
    const { key,label,aggrValue, ...rest } = col2Data;
    const column3Array = Object.values(rest).map((arr) => arr[0]);
    console.log(column3Array);
    const col2 = col2Data.label;
    console.log(col2)
    return (
